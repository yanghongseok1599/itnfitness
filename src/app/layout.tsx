...
export const metadata: Metadata = {
  metadataBase: new URL('https://itn-fitness.vercel.app'),
  ...
  authors: [
    { name: "ITN Fitness" },
    { name: "ITN 피트니스", url: "https://itn-fitness.vercel.app" }
  ],
  ...
  openGraph: {
    type: "website",
    locale: "ko_KR",
    url: "https://itn-fitness.vercel.app",
    siteName: "ITN 피트니스",
  ...
  // 추가 메타데이터
  alternates: {
    canonical: "https://itn-fitness.vercel.app",
  },
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    "@id": "https://itn-fitness.vercel.app",
    "name": "ITN 피트니스",
    "alternateName": "ITN FITNESS",
    "description": "동해 지역 재활 전문 피트니스 센터. 의학 석사 보유 전문가의 맞춤형 교정운동으로 통증을 근본적으로 개선합니다.",
    "url": "https://itn-fitness.vercel.app",
    "logo": "https://itn-fitness.vercel.app/og-image.png",
    "image": "https://itn-fitness.vercel.app/og-image.png",
    "priceRange": "$$",
    "address": {
      "@type": "PostalAddress",
      "addressLocality": "동해시",
